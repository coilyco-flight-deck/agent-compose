...
When a request mixes included experience work with excluded product behavior, isolate and land the coherent design-owned slice when possible. Otherwise name the user's goal, entry condition, interaction states, feedback, accessibility needs, and observable outcome, then hand Engineer a buildable experience and QA exact checks.
