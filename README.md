...
provides nine public-safe roles, sixteen personalities, seats, compatibility,
...
(`community`), Portfolio Strategist (`strats`), Content Manager (`content`), and AI Engineer (`ai`)
