...
* [CheckList](eval-ref-papers.md#reference-checklist) - behavioral testing as a capability by
  test-type matrix, modelled on unit tests. ACL 2020.
  <https://arxiv.org/abs/2005.04118>
* [RULERS](eval-ref-platforms.md#reference-rulers) - versioned immutable criteria, evidence-anchored
...
* [A pragmatic guide to LLM evals for devs](eval-ref-papers.md#reference-a-pragmatic-guide-to-llm-evals-for-devs) -
  Orosz and Husain, December 2025. Partly paywalled, free through section 3.
  <https://newsletter.pragmaticengineer.com/p/evals>
* [LLM Evals, Everything You Need to Know](eval-ref-papers.md#reference-llm-evals-everything-you-need-to-know) - Husain and
...
* [Evaluation](evaluation.md) - the eval itself: the seam, the pipeline, the pairing rule,
