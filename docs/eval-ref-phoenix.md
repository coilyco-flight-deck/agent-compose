...
This is `aos-eval annotate` with a vendor's name on it. Categorical annotation is
the pass-or-fail and three-way tiers, freeform is the critique on a deduction, and
