# The AI engineer role and its context budget

The AI engineer role, and the skill context budget a role works within.

## AI Engineer

AI Engineer owns the evidence loop for model and agent behavior:
...
method in that loop, not the whole role.
